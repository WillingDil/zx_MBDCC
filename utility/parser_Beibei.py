...
def parse_args():
    parser = argparse.ArgumentParser(description="Run MBDCC.")
    parser.add_argument('--weights_path', nargs='?', default='', help='Store model path.')
    parser.add_argument('--data_path', nargs='?', default='MBDCC/Data/', help='Input data path.')
    ...
    parser.add_argument('--Ks', nargs='?', default='[10, 50]', help='K for Top-K list')
    ...
    parser.add_argument('--mess_dropout', nargs='?', default='[0.3]',
                        help='Keep probability w.r.t. message dropout, 0.3 for beibei and taobao')
