...
class MBDCC(object):
    def __init__(self, max_item_view, max_item_cart, max_item_buy, data_config):
        ...
        *********************************************************
        ...
        self.n_relations = len(self.labels)
...
if __name__ == '__main__':
    ...
    *********************************************************
    ...
    max_item_buy, buy_label = get_labels(train_items)
    max_item_view, view_label = get_labels(pv_set)
    max_item_cart, cart_label = get_labels(cart_set)

    t0 = time()

    # build model
    model = MBDCC(max_item_view, max_item_cart, max_item_buy, data_config=config)
